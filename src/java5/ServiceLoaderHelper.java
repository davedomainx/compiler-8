...
public final class ServiceLoaderHelper<S>
    implements Iterable<S>
{
    ...
    private ServiceLoaderHelper(Class<S> svc, ClassLoader cl) {
        service = java5.ObjectsHelper.requireNonNull(svc, "Service interface cannot be null");
    ...
    private static void fail(Class<?> service, String msg, Throwable cause)
        throws ServiceConfigurationErrorHelper
    {
        throw new ServiceConfigurationErrorHelper(service.getName() + ": " + msg,
                                            cause);
    }
    ...
    private int parseLine(Class<?> service, URL u, BufferedReader r, int lc,
                          List<String> names)
        throws IOException, ServiceConfigurationErrorHelper
    {
     ...
     */
    public static <S> ServiceLoaderHelper<S> load(Class<S> service,
                                            ClassLoader loader)
    {
        return new ServiceLoaderHelper<S>(service, loader);
    }
    ...
    public static <S> ServiceLoaderHelper<S> load(Class<S> service) {
        ...
        return ServiceLoaderHelper.load(service, cl);
    }
     ...
     * @return A new service loader
     */
    public static <S> ServiceLoaderHelper<S> loadInstalled(Class<S> service) {
        ...
        return ServiceLoaderHelper.load(service, prev);
    }
