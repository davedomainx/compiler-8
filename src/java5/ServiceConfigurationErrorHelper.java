...
public class ServiceConfigurationErrorHelper
    extends Error
{
     ...
     *
     */
    public ServiceConfigurationErrorHelper(String msg) {
        super(msg);
    }
     ...
     *                or unknown
     */
    public ServiceConfigurationErrorHelper(String msg, Throwable cause) {
        super(msg, cause);
    }
