...
public class LambdaToMethod extends TreeTranslator {
    ...
    private class KlassInfo {
       ...
       /**
        ...
        private KlassInfo(JCClassDecl clazz) {
            this.clazz = clazz;
            appendedMethodList = new ListBuffer<JCTree>();
    ...
    public void visitLambda(JCLambda tree) {
        ...
        ListBuffer<JCExpression> syntheticInits = new ListBuffer<JCExpression>();
    ...
    private JCMethodDecl makeDeserializeMethod(Symbol kSym) {
        ...
        ListBuffer<JCBreak> breaks = new ListBuffer<JCBreak>();
    ...
    private void addDeserializationCase(int implMethodKind, Symbol refSym, Type targetType, MethodSymbol samSym,
        ...
        ListBuffer<JCExpression> serArgs = new ListBuffer<JCExpression>();
        int i = 0;
    ...
    private class MemberReferenceToLambda {
        ...
        private final ListBuffer<JCExpression> args = new ListBuffer<JCExpression>();
        private final ListBuffer<JCVariableDecl> params = new ListBuffer<JCVariableDecl>();
    ...
    private JCExpression makeMetafactoryIndyCall(TranslationContext<?> context,
        ...
        if (context.needsAltMetafactory()) {
            ListBuffer<Object> markers = new ListBuffer<Object>();
    ...
    class LambdaAnalyzerPreprocessor extends TreeTranslator {
        ...
        private class LambdaTranslationContext extends TranslationContext<JCLambda> {
            ...
            LambdaTranslationContext(JCLambda tree) {
                ...
                translatedSymbols = new EnumMap<LambdaSymbolKind, Map<Symbol, Symbol>>(LambdaSymbolKind.class);
                ...
                freeVarProcessedLocalClasses = new HashSet<Symbol>();
            }
            ...
            */
            ...
            void complete() {
                ...
                ListBuffer<VarSymbol> parameterSymbols = new ListBuffer<VarSymbol>();
