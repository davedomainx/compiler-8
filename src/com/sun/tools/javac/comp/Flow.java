     ...
     *************************************************************************/
        ...
        public void visitClassDef(JCClassDecl tree) {
            ...
            try {
                ...
                pendingExits = new ListBuffer<Flow.AssignAnalyzer.AssignPendingExit>();
                if (tree.name != names.empty) {
                    firstadr = nextadr;
                }
                classDef = tree;
        ...
        public void visitTry(JCTry tree) {
            ListBuffer<JCVariableDecl> resourceVarDecls = new ListBuffer<JCVariableDecl>();
     ...
     *************************************************************************/
        ...
        public void analyzeTree(Env<?> env, JCTree tree) {
            try {
                ...
                firstadr = 0;
                nextadr = 0;
                pendingExits = new ListBuffer<AssignAnalyzer.AssignPendingExit>();
                this.classDef = null;
