...
public class JNIWriter {
        ...
        throws IOException
    {
        ...
        // WARATEK: repalced use of 'NATIVE_HEADER_OUTPUT' as this is
        //          not supported on Java7
        //FileObject outFile
        //    = fileManager.getFileForOutput(StandardLocation.NATIVE_HEADER_OUTPUT),
        //        "", className.replaceAll("[.$]", "_") + ".h", null);
        FileObject outFile
            = fileManager.getFileForOutput(StandardLocation.SOURCE_OUTPUT,
                "", className.replaceAll("[.$]", "_") + ".h", null);
    ...
    public void write(Writer out, ClassSymbol sym)
        ...
        try {
            ...
            throw java5.IOExceptionHelper.init(e);
        }
    }
