...
//import java.util.ServiceConfigurationErrorHelper;
    ...
    implements Iterable<S>
{
    ...
    private static void fail(Class<?> service, String msg, Throwable cause)
        throws java5.ServiceConfigurationErrorHelper
    {
        throw new java5.ServiceConfigurationErrorHelper(service.getName() + ": " + msg,
                                            cause);
    }
    ...
    private int parseLine(Class<?> service, URL u, BufferedReader r, int lc,
                          List<String> names)
        throws IOException, java5.ServiceConfigurationErrorHelper
    {
     ...
     * {@link ServiceConfigurationErrorHelper} if a provider-configuration file
     * violates the specified format, or if it names a provider class that
     * cannot be found and instantiated, or if the result of instantiating the
     * class is not assignable to the service type, or if any other kind of
     * exception or error is thrown as the next provider is located and
     * instantiated.  To write robust code it is only necessary to catch {@link
     * ServiceConfigurationErrorHelper} when using a service iterator.
     *
