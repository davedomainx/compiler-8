...
class RegularFileObject extends BaseFileObject {
    ...
    public boolean isNameCompatible(String cn, JavaFileObject.Kind kind) {
        ...
        if (isMacOS && java5.NormalizerHelper.isNormalized(name, java5.NormalizerHelper.Form.NFD)
            && java5.NormalizerHelper.isNormalized(n, java5.NormalizerHelper.Form.NFC)) {
            ...
            String normName = java5.NormalizerHelper.normalize(name, java5.NormalizerHelper.Form.NFC);
