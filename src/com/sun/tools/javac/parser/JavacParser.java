...
/* ---------- parsing -------------- */
    ...
    //where
        ...
        protected JCExpression foldStrings(JCExpression tree) {
            if (!allowStringFolding)
                return tree;
            ListBuffer<JCExpression> opStack = new ListBuffer<JCExpression>();
            ListBuffer<JCLiteral> litBuf = new ListBuffer<JCLiteral>();
    ...
    JCExpression arrayCreatorRest(int newpos, JCExpression elemtype) {
        ...
        if (token.kind == RBRACKET) {
            ...
            ListBuffer<List<JCAnnotation>> dimAnnotations = new ListBuffer<List<JCAnnotation>>();
    ...
    List<JCExpression> catchTypes() {
        ListBuffer<JCExpression> catchTypes = new ListBuffer<JCExpression>();
