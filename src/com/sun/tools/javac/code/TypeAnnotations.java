...
public class TypeAnnotations {
    ...
    private class TypeAnnotationPositions extends TreeScanner {
         ...
         */
        private ListBuffer<JCTree> frames = new ListBuffer<JCTree>();
        ...
        private Type typeWithAnnotations(final JCTree typetree, final Type type,
            ...
            if (type.hasTag(TypeTag.ARRAY)) {
                ...
                ListBuffer<TypePathEntry> depth = new ListBuffer<TypePathEntry>();
        ...
        private void resolveFrame(JCTree tree, JCTree frame,
            ...
            */
            ...
            switch (frame.getKind()) {
                ...
                case ARRAY_TYPE: {
                    ListBuffer<TypePathEntry> index = new ListBuffer<TypePathEntry>();
