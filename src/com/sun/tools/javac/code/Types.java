...
public class Types {
    ...
    class DescriptorCache {
        ...
        public FunctionDescriptor findDescriptorInternal(TypeSymbol origin,
            ...
            final ListBuffer<Symbol> abstracts = new ListBuffer<Symbol>();
...
//                    debugContainsType(t, s);
    ...
    class MembersClosureCache extends SimpleVisitor<Scope.CompoundScope, Void> {
        ...
        private Map<TypeSymbol, CompoundScope> _map = new HashMap<TypeSymbol, CompoundScope>();

        Set<TypeSymbol> seenTypes = new HashSet<TypeSymbol>();
    ...
    public List<MethodSymbol> prune(List<MethodSymbol> methods) {
        ListBuffer<MethodSymbol> methodsMin = new ListBuffer<MethodSymbol>();
    ...
    public List<Type> substBounds(List<Type> tvars,
        ...
        if (!changed)
            return tvars;
        ListBuffer<Type> newTvars = new ListBuffer<Type>();
    ...
    private List<Type> closureMin(List<Type> cl) {
        ...
        Set<Type> toSkip = new HashSet<Type>();
        while (!cl.isEmpty()) {
